...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> call = retrofit.create(IMiniDouyinService.class).createVideo("1120172732","陈家祺",
    ...
    public void fetchFeed(View view) {
        ...
        Retrofit retrofit1 = RetrofitManager.get("http://test.androidcamp.bytedance.com/");
        Call<FeedResponse> FeedResponseCall = retrofit1.create(IMiniDouyinService.class).fetchFeeds();
